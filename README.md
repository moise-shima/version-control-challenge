...
> A complete beginner-friendly guide to understanding Git, GitHub, branches, pull requests, and collaborative development workflows.
...
8. GitHub Workflow Example
9. Git File Status Colors
10. Best Practices
11. Common Mistakes Beginners Make
12. Advantages of Using Git & GitHub
13. Conclusion
...
Many beginners experience problems while learning Git. Here are some common mistakes and how to avoid them:

| Mistake                         | Solution                                |
| ------------------------------- | --------------------------------------- |
| Forgetting to commit changes    | Commit regularly after completing tasks |
| Pushing directly to `main`      | Use branches for safer development      |
| Writing unclear commit messages | Use meaningful and descriptive messages |
| Not pulling before pushing      | Always pull latest changes first        |
| Accidentally deleting files     | Check `git status` before committing    |
...
Git provides many benefits for software development:
...
* Allows open-source contribution
* Provides backup for projects

---

# Markdown Formatting Examples

GitHub uses **Markdown** to format README files.
